...
5. Click on **Upload** to upload the document(s). In the **Upload blob** pane, click on the folder icon to select the file(s) from your local machine. Select a document or multiple documents and click **Upload**. 
    ...
    > **Note**: You can use demo files located in the `demofiles` folder to test the indexing process.
...
<!-- ### Task 2: Create an Agent flow using a Custom Connector
...
### Task 2: Create An Agent and Connect to the Custom Connector
...
4. Add all the inputs required by the custom connector as follow:
  ...
  ```
  Fill using Dynamically fill with AI Value:
    - **Body/search**:
  ```

   <img src="../2.1-ai-search-advanced/images/31.png" >

   <br>

5. Click on **Customize** for the **search** input.

   <img src="../2.1-ai-search-advanced/images/32.png" >

   <br>

6. Set **City** in the **Identify as** field, to the the AI to extract the search term from the user query, and click on **Save**.

   <img src="../2.1-ai-search-advanced/images/33.png" >

   <br>

7. Edit the tool to assure you had selected **Write the response with generative AI** in the **Completion** section.

   <img src="../2.1-ai-search-advanced/images/20a.png" >

   <br>

### Task 3: Test your agent with a Custom Connector
1. Go to the **Test your agent** pane to test your agent. You can ask questions related to the documents you uploaded to Azure AI Search in Exercise 1 - Task 1. (eg. What hotel is located in Paris?)
...
2. You will see the executed queries and the answers provided by the agent.
   ...
   <img src="../2.1-ai-search-advanced/images/21a.png">
