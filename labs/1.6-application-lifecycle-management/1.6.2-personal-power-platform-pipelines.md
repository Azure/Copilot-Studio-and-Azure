...
![Environment Selector](./images/copilot-environment-selector.png)
...
![Environment Selector](./images/copilot-solutions-page.png)
...
![Add agent to solution](./images/copilot-add-agent.png)
...
![Create Pipeline](./images/pipelines-create.png)
...
![Run Pipeline](./images/pipelines-run-1.png)

![Run Pipeline](./images/pipelines-run-2.png)

![Run Pipeline](./images/pipelines-run-3.png)

![Run Pipeline](./images/pipelines-run-4.png)

![Run Pipeline](./images/pipelines-run-5.png)
...
![Verify Import](./images/copilot-verify-import.png)
