...
1. In the Azure Subcription you should have an Azure Storage with a Container containing a licensing guide  "Power-Platform-Licensing-Guide-MMMM-YYYY.pdf" (https://go.microsoft.com/fwlink/?linkid=2085130)
    ...
    <img src="./images/LabAISearch_Picture05.png" width="100%" height="100%">

    <br>

2. In Addition check for an Azure AI Search service

    <img src="./images/LabAISearch_Picture06.png" width="100%" height="100%">
    ...
    <img src="./images/LabAISearch_Picture07.png" width="100%" height="100%">

    <br>

3. Review also you have deployed an embeddings model in Azure Open AI

    <img src="./images/LabAISearch_Picture08.png" width="100%" height="100%">
    ...
    <img src="./images/LabAISearch_Picture09.png" width="100%" height="100%">

    <br>

    <img src="./images/LabAISearch_Picture10.png" width="100%" height="100%">

    <br>

    You have connected Azure AI Search to your agent
