...
90 minutes
## Exercise 1: Use Azure AI as knowledge source

### Task 1: Remove knowledge sources

1.	Open with **Copilot Studio** agent you created in **[Lab 0.0 - Create an agent](../0.0-create-an-agent/0.0-create-an-agent.md)** and remove from **Knowledge** the file about Power *Platform licensing* we uploaded to the agent.

    <img src="./images/LabAISearch_Picture37.png" width="90%" height="90%">

### Task 2: Create Azure AI Search configuration
...
2. Create a new storage account (click **Create**)
    ...
    <img src="./images/LabAISearch_Picture20.png" width="80%" height="80%">
...
3. Set permission for the storage account
    ...
    <img src="./images/LabAISearch_Picture23.png" width="80%" height="80%">
    ...
    <img src="./images/LabAISearch_Picture24.png" width="80%" height="80%">
    ...
    <img src="./images/LabAISearch_Picture25.png" width="80%" height="80%">
...
4. Add a container to the Azure Storage
    ...
    <img src="./images/LabAISearch_Picture21.png" width="80%" height="80%">

    <br>

    Click on tab **Add container** and set a **Name** for the container (i.e. **cs-licensingdocs**). Click on **Create**

    <img src="./images/LabAISearch_Picture22.png" width="80%" height="80%">
    ...
    >
    >   <img src="./images/LabAISearch_Picture36.png" width="80%" height="80%">
...
5. Create Open AI resource
   ...
   <img src="./images/LabAISearch_Picture27.png" width="80%" height="80%">
    ...
    <img src="./images/LabAISearch_Picture28.png" width="80%" height="80%">

    <br>

    Navigate to Foundry portal clicking on **Go to Foundry portal** in your Open AI resource.

   <img src="./images/LabAISearch_Picture29.png" width="80%" height="80%">
    ...
    <img src="./images/LabAISearch_Picture30.png" width="80%" height="80%">

    <br>

    Seek in the Searh box for a **text** model, select one of those (i.e. **text-embedding-3-large**) and **Confirm**

   <img src="./images/LabAISearch_Picture31.png" width="80%" height="80%">
...
6. Create an Azure AI Search resource
    ...
    <img src="./images/LabAISearch_Picture32.png" width="80%" height="80%">
   ...
   <img src="./images/LabAISearch_Picture33.png" width="80%" height="80%">
...
7. Vectorize Data (our licensing file) in Ai Search
   ...
   <img src="./images/LabAISearch_Picture34.png" width="80%" height="80%">
    ...
    **Check** to acknowledge connecting to an Azure OpenAI service will incur in additional costs and click **Next** and skip the pages (clicking **Next**) for *Vectorize and enrich your images* and *Advance settings**. Finally select **Create**
    ...
    > **Note** If you are using an Azure subscription for which you are not an administrator, key-based access to storage may have been disallowed by policy. In this case, **Authentication type** has to be set as **System assigned identity** (recommended) or **User assigned identity**, in order the indexing process works. Review the Appendix at the end of this lab for details about how to configure *Manage identities* to run in that scenario.
>

### Task 3: Connect agent to Azure AI Search
...
2. Back to our **Licensing Assistant** agent in Copilot Studio, go to the agent's **Knowledge tab**, click **"Add Knowlege"** button and select **Azure AI Search** in the dialog that appears.
   ...
   <img src="./images/LabAISearch_Picture13.png" width="80%" height="80%">

   <br>

3. You will have to **create a new connection** and **Add to agent**
   
   <img src="./images/LabAISearch_Picture14.png" width="80%" height="80%">

   <br>

You are now ready to test your agent using Azure AI Search as Knowledge source

### Task 4: Use Azure AI Search in you agent
...
## Appendix: Configure Azure Search Manage identities

1. Open your **Azure AI Serch** service in Azure portal and find in left menu **Identity** on **Settings** section. Review **System assigned** tab is selected and set the **Status** togle to **On**. Wait for a value in **Object (principal) ID**.

    <img src="./images/LabAISearch_Picture39.png" width="100%" height="100%">

<br>

2. Below **Object (principal) ID** select **Azure role assignments** and click in **Add role assigment**. Set the following settings:
      
   - Scope: Storage
   - Subcription: Your Azure subscription
   - Resource: Storage with the container where you upload licensing file
   - Role: Storage Blob Data Reader
  
    <img src="./images/LabAISearch_Picture40.png" width="100%" height="100%">

    <br>
  
    Click **Save** and wait for the role assignment to finish. Repeat the operation with the role **Add Reader and Data Access**

3. Next step is to make something similar to permit **AI Search** to access our **Open AI** service and use embeddings model. Go to the **Open AI** service you have created previosly and select **Access control (IAM)** in the left menu. Next, select **+ Add** and **Add role assignment** in top menu. In **Job function roles** look for **Cognitive Services OpenAI Contributor**, select it and click in **Members** tab.
   
    <img src="./images/LabAISearch_Picture41.png" width="100%" height="100%">

    <br>

4. In the new dialog, choose **Managed identity** for **Assign access to** configuration, and click on **+ Select members**. In the right form, in combo **Managed identity** looks for the category **Search service** and choose the right one for the lab. Click on **Select** and after **Review + assign** in the **Add role asignment** dialog.

   
    <img src="./images/LabAISearch_Picture42.png" width="100%" height="100%">

    <br>

    Repeat the same operation with the role **Cognitive Services Contributor**

5. Finally, back again in **AI Search** service, we need to provide a couple of roles in the service to all of the users that are going to connect from Copilot Studio. In left menu select **Access control (IAM)**, click of tab **+ Add** and **Add Role asignment**, look for the roles, first **Search Services Contributor** needed to read indexes in the service, assign in **Members** dialog to user o group of users using the service, and second, repeat for the role **Search Index Data Reader** to be able to search in indexes.

6. Next, you can repeat the process to vectorize data (**Action 7, Task 2, Exercise 1**) or launch again the indexing process going in left menu to **Indexers**, selecting the index (probably it failed because API keys forbidden), and get running again (click **Run**)
   
    <img src="./images/LabAISearch_Picture43.png" width="100%" height="100%">

    <br>
7. Last but not least, remember create a new connection to AI Search en Copilot Studio, selecting **Authentication type** with **Microsoft Entra ID Integrated**. It could be possible the other two options (i.e. *Service Pricipal* or *Certificate*); on these case you have to manage accordingly to set the same roles in *Ai Search* as you did for the users.
