...
2. Navigate to **Overview** → Copy the **Connection String**.

> **Note:** Microsoft is deprecating Instrumentation Keys in favor of Connection Strings. Always use the Connection String when configuring telemetry.
...
5. Paste the **Connection String** from Application Insights.
6. Save changes.
...
1. Select **Edit** in the command bar to modify tiles — you can add, move, resize, or remove elements. For example, add a KQL tile to track a custom attribute not shown in the built-in view.
2. Select **Save** to persist your changes.
3. Select the **Share** icon to share the workbook with your team.

> **Important:** Team members must have at least the **Reader** role on the Application Insights resource to view shared workbooks.
